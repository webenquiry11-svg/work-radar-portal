  ...
  return (
    <div className="p-4 sm:p-8 lg:p-12 h-full flex flex-col bg-gradient-to-br from-slate-50 to-white dark:bg-black dark:text-white">
      <div className="mb-8 text-center">
        ...
        <p className="text-slate-500 dark:text-white mt-2">Delegate tasks to managers. Click "Assign Task" to add one or more tasks for a manager.</p>
      </div>
      <div className="bg-white dark:bg-black rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto rounded-b-2xl p-4">
          {filteredEmployees.length === 0 ? (
            <div className="text-center text-slate-400 dark:text-white py-16">No managers found.</div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredEmployees.map(employee => (
                <div key={employee._id} className="bg-gradient-to-br from-white to-blue-50 dark:from-black dark:to-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow hover:shadow-lg transition-shadow p-6 flex flex-col items-center">
                  <img
