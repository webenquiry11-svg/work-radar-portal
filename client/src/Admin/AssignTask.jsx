        ...
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-y-auto">
          <div className="flex-1 px-6 py-4 space-y-6">
            ...
            <button
              type="button"
              onClick={addTask}
              className="w-full flex items-center justify-center gap-2 text-sm font-semibold text-blue-600 hover:text-blue-700 border-2 border-dashed border-blue-300 hover:border-blue-400 rounded-lg py-2 transition-colors"
            >
  ...
  return (
    <div className="p-4 sm:p-8 lg:p-12 h-full flex flex-col bg-gradient-to-br from-slate-50 to-white">
      <div className="mb-8 text-center">
        ...
        <p className="text-slate-500 mt-2">Delegate tasks to managers. Click "Assign Task" to add one or more tasks for a manager.</p>
      </div>
      <div className="bg-white rounded-2xl border border-slate-200 shadow-lg flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto rounded-b-2xl p-4">
          {filteredEmployees.length === 0 ? (
            <div className="text-center text-slate-400 py-16">No managers found.</div>
          ) : (
