      ...
      <div className="bg-white/80 backdrop-blur-lg rounded-2xl border border-gray-200 shadow-xl p-8">
        <div className="flex justify-between items-start mb-8 pb-8 border-b border-gray-200">
          ...
          <div className="flex flex-col gap-2 items-end">
            ...
            <button onClick={handleRequestPasswordReset} disabled={isSendingReset} className="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-red-600 transition-colors disabled:bg-red-300 w-full sm:w-auto">
              {isSendingReset ? 'Sending...' : 'Request Password Reset'}
            </button>
          </div>
        </div>
