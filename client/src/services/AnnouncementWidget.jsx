...
const AnnouncementWidget = () => {
  ...
  return (
    <div className="bg-blue-50 dark:bg-black border-b-2 border-blue-200 dark:border-blue-800 p-3 mb-8">
      <div className="flex items-center justify-between max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          <MegaphoneIcon className="h-6 w-6 text-blue-500" />
          <p className="font-bold text-sm text-blue-900 dark:text-white">{announcement.title}</p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <p className="text-sm text-slate-700 dark:text-white">{announcement.content}</p>
        </div>
